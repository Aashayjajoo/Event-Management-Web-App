    ...
    <body>
        ...
        <div id="intro" class="header-container fs">
            ...
            <header class="wrapper">
                <h1 class="title">Welcome To Snap-Ticket!</h1>
                <p></p>
            </header>
           
           <form action="signin.jsp">       
 			<button span class="scroll-hint" type="submit" value="Submit" style="margin-left: -20%">Create Event
 			</button></form>
 			<form action="buyersignin.jsp">       
 			<button span class="scroll-hint" type="submit" value="Submit" style="margin-left: 20%">Buy Ticket
 			</button></form>
        </div>
        ...
        <nav>
            <ul>
                ...
                <li><a href="#slide02"><span class="nav-dot"></span><span class="nav-label">About Us</span></a></li>
                <li><a href="#slide03"><span class="nav-dot"></span><span class="nav-label">Register</span></a></li>
            </ul>
        </nav>
        ...
        <div class="main-container">
            ...
            <article id="cb01" class="content-block">
                <div class="wrapper">
                    ...
                    <section>
                        <p class="slideInUp slideInUp2">KEEP CALM AND PLAN EVENTS</p>
                    </section>
                </div> <!-- .wrapper -->
            </article>
            ...
            <article id="slide01" class="slide fs">
                ...
                <div class="wrapper">
                    <header class="slideInUp">
                        <h1>Events become Feelings, Feelings become events</h1>
                    </header>
                    <section>
                        <p class="slideInUp slideInUp2">Plans are nothing. Planning is everything.</p>
                    </section>
                </div> <!-- .wrapper -->
            </article>
            ...
            <article id="slide02" class="slide fs">
                ...
                <div class="wrapper">
                    ...
                    <section>
                        ...
                        <p class="slideInUp slideInUp3">Devoloped by - Aashay, Divyansh</p>
                        <p class="slideInUp slideInUp3">PRN - 15070121502,515</p>
                        <p class="slideInUp slideInUp3">Batch - IT 2015-19</p>
                    </section>
                </div> <!-- .wrapper -->
            </article>
            ...
            <article id="cb03" class="content-block">
                <div class="wrapper">
                    ...
                    <section>
                        <p class="slideInUp slideInUp2">Manage event with the simple touch </p>
                    </section>
                </div> <!-- .wrapper -->
            </article>
            ...
            <article id="slide03" class="slide fs">
                ...
                <div class="wrapper">
                    <header class="slideInUp">
                        ...
                        <h1>BE SOMEBODY NOBODY THOUGHT YOU COULD BE</h1>
                    </header>
