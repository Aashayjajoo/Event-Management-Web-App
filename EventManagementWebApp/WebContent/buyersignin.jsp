...
<html lang="en">
<head>
	<title>Buyer SignIn : Snap Tickets</title>
	<meta charset="utf-8">
...
<form class="col s12" name="myForm" action="LoginBuyer" method="post">
